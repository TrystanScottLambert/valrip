...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v1.0.1/valrip-macos-arm64
```
...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v1.0.1/valrip-macos-x86_64
```
...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v1.0.1/valrip-linux-amd64
```
...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v1.0.1/valrip-linux-arm64
```
