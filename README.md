...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v0.0.9/valrip-macos-arm64
```
...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v0.0.9/valrip-macos-x86_64
```
...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v0.0.9/valrip-linux-amd64
```
...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v0.0.9/valrip-linux-arm64
```
