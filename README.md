...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v2.0.0/valrip-macos-arm64
```
...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v2.0.0/valrip-macos-x86_64
```
...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v2.0.0/valrip-linux-amd64
```
...
```
curl -L -o valrip https://github.com/TrystanScottLambert/valrip/releases/download/v2.0.0/valrip-linux-arm64
```
